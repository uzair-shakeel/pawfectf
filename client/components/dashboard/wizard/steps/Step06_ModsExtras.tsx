                                    ...
                                    {[
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-xl text-md font-semibold transition-all border-2 ${isSelected
                                    ...
                                    {addingTo === category.id ? (
                                        <div className="flex items-center gap-1 animate-in fade-in slide-in-from-left-2">
                                            <input
                                                ...
                                                placeholder="Custom..."
                                                className="px-3 py-1.5 rounded-xl text-md border-2 border-blue-500 bg-white dark:bg-dark-bg outline-none w-32 placeholder:text-gray-400"
                                            />
                                            <button
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 rounded-xl text-md font-semibold border-2 border-dashed border-gray-200 dark:border-gray-700 text-gray-400 hover:border-blue-400 hover:text-blue-500 transition-all flex items-center gap-1"
                                        >
