    ...
    return (
        <div className="space-y-6">
            ...
            >
                ...
                <div className="mt-4">
                    <label className="block text-md font-medium text-gray-700 dark:text-gray-300 mb-3 ml-1">Privacy Protection</label>
                    <button
                ...
                {/* Error message */}
                {blurError && (
                    <div className="mt-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-md text-red-600 dark:text-red-400">
                ...
                {isBlurringPlates && (
                    <div className="mt-2 flex items-center gap-2 text-md text-blue-600 dark:text-blue-400">
                ...
                {formData.images?.length > 0 && (
                    <div className="mt-6">
                        <label className="block text-md font-medium text-gray-700 dark:text-gray-300 mb-3 ml-1">Photo Style</label>
                        <div className="grid grid-cols-3 gap-3">
                            {[
                                ...
                                >
                                    ...
                                    <div className={`text-md font-bold mb-1 ${formData.photoFilter === preset.key || (!formData.photoFilter && preset.key === "none") ? "text-blue-700 dark:text-blue-300" : "text-gray-900 dark:text-white"}`}>
                                        {preset.name}
                                    </div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400">{preset.desc}</div>
                                </button>
                            ))}
                        </div>
                    </div>
                ...
                {formData.images?.length > 0 && (
                    ...
                    >
                        ...
                        <QuestionCard title="VIN Number" subtitle="Enter VIN for automatic decoding (Recommended)">
                            <div className="relative">
                                ...
                                <div className="absolute right-4 top-1/2 -translate-y-1/2">
                                    {formData.vin?.length === 17 ? (
                                        <span className="text-green-500 flex items-center gap-1 text-md font-medium animate-in fade-in slide-in-from-right-2">
                            ...
                            <div className="mt-3 flex items-start gap-2 text-md text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/10 p-3 rounded-lg border border-blue-100 dark:border-blue-800">
                        ...
                        <QuestionCard title="Condition">
                            <div className="space-y-6">
                                <div>
                                    <label className="block text-md font-medium text-gray-700 dark:text-gray-300 mb-3 ml-1">Vehicle Condition</label>
