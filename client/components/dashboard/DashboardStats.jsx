...
const API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL ? (process.env.NEXT_PUBLIC_API_BASE_URL.replace(/\/$/, "").endsWith('/api') ? process.env.NEXT_PUBLIC_API_BASE_URL.replace(/\/$/, "") : `${process.env.NEXT_PUBLIC_API_BASE_URL.replace(/\/$/, "")}/api`) : "/api";
