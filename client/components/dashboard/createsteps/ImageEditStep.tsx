    ...
    <>
      <div className="bg-white dark:bg-dark-main rounded-lg w-full transition-colors">
        <div className="flex items-center justify-between mb-2">
          ...
          {isUploading && (
            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full text-sm font-bold border border-blue-100 dark:border-blue-800">
        ...
        {formData.images.length === 0 ? (
          <div className="mb-6">
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center bg-gray-50 dark:bg-dark-card/50">
              ...
              <p className="text-md text-gray-500 dark:text-gray-400 mb-4">Dodaj zdjęcia auta tutaj. Możesz je edytować od razu po załadowaniu.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 dark:bg-dark-card/50 p-4 rounded-lg">
              ...
              <div className="mb-3">
                <label className="inline-flex items-center gap-2 cursor-pointer text-md text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold uppercase tracking-wider">
            ...
            */}
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700 text-md text-gray-500 dark:text-gray-400 flex justify-between items-center">
            ...
            <div className="p-4 grid grid-cols-2 sm:grid-cols-3 gap-4">
              {Object.keys(filterPresets).map((presetKey) => (
                ...
                >
                  ...
                  <span className="text-md font-bold text-gray-700 dark:text-gray-300 group-hover/preset:text-blue-600 transition-colors">
                    {
