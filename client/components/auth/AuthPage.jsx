      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full p-10 justify-between">
          ...
          <Link href="/" className="inline-flex items-center">
            <Image src="/logo-white.png" alt="Pawfect" width={130} height={36} className="h-10 w-auto" />
          </Link>
          ...
          <div className="pb-4">
            ...
            <h2 className="text-4xl xl:text-5xl font-black text-white leading-tight mb-4">
              Find Your<br />
              <span className="text-blue-300">Pawfect</span><br />
              Companion
            </h2>
      ...
      <div className="w-full lg:w-[55%] xl:w-1/2 flex items-center justify-center bg-white dark:bg-dark-main p-6 md:p-10 overflow-y-auto">
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex lg:hidden justify-center mb-8">
            <Link href="/">
              <Image src="/logo.png" alt="Pawfect" width={120} height={34} className="h-9 w-auto dark:hidden" />
              <Image src="/logo-white.png" alt="Pawfect" width={120} height={34} className="h-9 w-auto hidden dark:block" />
            </Link>
          </div>
          ...
          {step === "otp" ? (
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">
                  {tab === "login"
                    ? "Sign in to your Pawfect account"
                    : "Join thousands of pet lovers on Pawfect"}
                </p>
              </div>
