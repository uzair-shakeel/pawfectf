...
export default function AddPetPage() {
  ...
  const inputClass =
    "mt-1.5 w-full rounded-xl border border-[#E2E8F0] bg-white px-4 py-3 text-base text-[#0F172A] outline-none placeholder:text-[#94A3B8] focus:border-[#2563EB] dark:border-dark-divider dark:bg-dark-raised dark:text-white disabled:opacity-50";
  const labelClass = "text-sm font-semibold text-[#0F172A] dark:text-gray-200";
  const primaryBtn =
    "inline-flex h-12 items-center justify-center bg-[#2563EB] px-7 text-sm font-semibold text-white transition hover:bg-[#1D4ED8] disabled:cursor-not-allowed disabled:opacity-50";
  const ghostBtn =
    "inline-flex h-12 items-center justify-center px-5 text-sm font-semibold text-[#64748B] transition hover:bg-[#F1F5F9] hover:text-[#0F172A] dark:hover:bg-dark-raised dark:hover:text-white";

  const stepLabels = [
    t("dashboard:addPet.steps.photos", "Photos"),
    t("dashboard:addPet.steps.details", "Details"),
    t("dashboard:addPet.steps.healthBio", "Health & Bio"),
  ];
  ...
  return (
    <div className="marketing-ui mx-auto max-w-4xl p-4 sm:p-6 md:p-8">
      <div className="mb-6">
        ...
        <p className="mt-1.5 max-w-xl text-sm text-[#64748B] dark:text-gray-400">
          {t("dashboard:addPet.subtitle", "Provide detailed information to help them find a loving home.")}
        </p>
      </div>
      ...
      >
        {/* Stepper only — no duplicate progress bar */}
        <div className="border-b border-[#E2E8F0] px-5 py-5 dark:border-dark-divider sm:px-8 sm:py-6">
          <div className="relative w-full">
            <div className="pointer-events-none absolute left-[16.666%] right-[16.666%] top-[18px] h-[2px] bg-[#CBD5E1] dark:bg-white/20" />
            <div
              className="pointer-events-none absolute left-[16.666%] top-[18px] h-[2px] bg-[#2563EB] transition-all duration-400"
              style={{
                width:
                  step <= 1
                    ? "0%"
                    : `calc(66.666% * ${((step - 1) / (stepLabels.length - 1))})`,
              }}
            />
                    ...
                    <div
                      className={`flex h-9 w-9 shrink-0 items-center justify-center text-sm font-bold ${
                        active
                          ...
                          : "border-2 border-[#CBD5E1] bg-white text-[#94A3B8] dark:border-white/25 dark:bg-dark-card dark:text-gray-400"
                      }`}
                    >
                      {s}
                    </div>
                    <span
                      className={`mt-2 text-center text-xs font-semibold leading-snug sm:text-sm ${
        ...
        <div className="space-y-6 px-5 py-6 sm:px-8 sm:py-7">
          ...
          {analyzeInfo && (
            <div className="flex items-start gap-2 border-l-2 border-[#2563EB] bg-[#EEF2FF] px-4 py-3 text-sm text-[#1E40AF] dark:bg-[#2563EB]/15 dark:text-blue-200">
          ...
          {step === 1 && (
            <section>
              <p className="mb-5 text-sm text-[#64748B] dark:text-gray-400">
                {t(
              ...
              <label
                className={`flex aspect-square cursor-pointer flex-col items-center justify-center border-2 border-dashed border-[#2563EB]/40 bg-[#EEF2FF] text-[#2563EB] transition hover:border-[#2563EB] hover:bg-[#DBEAFE] dark:bg-[#2563EB]/10 ${
              ...
              {previews.map((src, i) => (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={analyzing}
                    className="absolute right-2 top-2 z-20 bg-[#0F172A]/70 p-1.5 text-white transition disabled:opacity-40 sm:opacity-0 sm:group-hover:opacity-100"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </div>
        ...
        {step === 2 && (
          <section className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div className="md:col-span-2">
              <h2 className="text-sm font-semibold uppercase tracking-wide text-[#64748B] dark:text-gray-400">
            ...
            <div>
              ...
              <div className="mt-1.5 flex gap-2">
                ...
                <button
                  ...
                  className="flex h-[50px] w-[50px] shrink-0 items-center justify-center bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300"
                >
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.healthStatus.map((h, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-1.5 border border-emerald-200 bg-emerald-50 px-3 py-1 text-sm font-semibold text-emerald-700 dark:border-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-300"
                  >
                    {h}
            ...
            <div>
              ...
              <div className="mt-1.5 flex gap-2">
                ...
                <button
                  ...
                  className="flex h-[50px] w-[50px] shrink-0 items-center justify-center bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-300"
                >
                  <Plus className="h-5 w-5" />
                </button>
              </div>
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.personality.map((p, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-1.5 border border-violet-200 bg-violet-50 px-3 py-1 text-sm font-semibold text-violet-700 dark:border-violet-800 dark:bg-violet-900/20 dark:text-violet-300"
                  >
                    {p}
            ...
            <div className="md:col-span-2">
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-semibold transition disabled:opacity-60 ${
                    listening
              ...
              <div className="relative">
                ...
                <button
                  ...
                  onClick={toggleVoiceInput}
                  disabled={fixingVoice}
                  className={`absolute bottom-3 right-3 p-2 transition ${
                    listening
