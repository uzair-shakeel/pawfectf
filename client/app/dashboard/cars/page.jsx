  ...
  return (
    <div className="p-4 max-w-7xl mx-auto dark:bg-dark-main">
      <div className="flex flex-col sm:flex-row justify-between items-end gap-4 md:gap-0 mb-12">
        <div>
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">My Pets</h1>
          <p className="text-gray-500 mt-2 font-medium">Manage your adoption listings.</p>
        </div>
        <Link
      ...
      {pets && pets.length > 0 && pets.some((p) => p.status !== "Approved") && (
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm mt-1 opacity-90">Some of your listings are being reviewed. They will be visible to adopters once approved by an administrator.</p>
          </div>
        </motion.div>
      )}
      ...
      {pets.length === 0 ? (
        <div className="text-center py-24 bg-gray-50 dark:bg-dark-card rounded-3xl border-2 border-dashed border-gray-200 dark:border-dark-divider">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No pets listed yet</h3>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {pet.status === "Approved" ? (
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400">
                      <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 mr-2 animate-pulse"></span> Under Review
                    </span>
                  ) : (
