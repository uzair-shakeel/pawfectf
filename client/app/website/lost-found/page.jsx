        ...
        <div className="min-h-screen bg-gray-50 dark:bg-dark-main py-12 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                    <div>
                        <h1 className="text-4xl font-black text-gray-900 dark:text-white">Lost & Found Pets</h1>
                        <p className="text-gray-500 dark:text-gray-400 mt-2 text-lg">Help reunite pets with their families.</p>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white dark:bg-dark-card rounded-3xl border border-gray-100 dark:border-dark-divider">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">There are currently no {filter.toLowerCase()} pet reports.</p>
                    </div>
                ) : (
                            ...
                            <div key={entry._id}>
                                <PetCard 
                                    car={{
                                        ...
                                        customLabel: entry.type === 'Lost' ? 'Lost Pet' : 'Found Pet',
                                        adoptionFee: 0,
                                    }} 
                                    viewMode="grid" 
                                />
